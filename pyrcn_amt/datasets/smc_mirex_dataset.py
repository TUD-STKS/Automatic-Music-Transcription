...
def download_dataset(dataset_path: str = None):
    """
    This function aims to download the SMC MIREX Dataset
    :param dataset_path:
    :return:
    """
...
def load_dataset(dataset_path: str = None, fold_id: int = 0):
    """
    This function aims to load the SMC MIREX Dataset.
    :param dataset_path:
    :param fold_id:
    :return:
    """
...
if __name__ == "__main__":
    train_files, test_files = load_dataset(dataset_path=r"C:\Temp\beat_tracking_datasets\SMC_MIREX")
